    ...
    return (
        <div className={styles.page}>
                                        ...
                                        <div className={styles.row}>
                                            {view === "active" ? (
                                                <>
                                                    ...
                                                    <button className={styles.btn} onClick={() => onDelete(r.id)} disabled={busy}>
                                                        Delete
                                                    </button>
                                                </>
                                            ) : (
                                                <button className={styles.btn} onClick={() => onRestore(r.id)} disabled={busy}>
                                                    Restore
                                                </button>
                                            )}
                                        </div>
            ...
            <Modal title="Create pizza" isOpen={creating} onClose={() => setCreating(false)}>
                <PizzaForm mode="create" busy={busy} onCancel={() => setCreating(false)} onSubmit={handleCreate} />
            </Modal>
